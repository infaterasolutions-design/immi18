...
export default function Home() {
  useEffect(() => {
    [['top-stories','top-stories-scroll'],['video-highlights','video-highlights-scroll']].forEach(([prefix, scrollId]) => {
        ...
        if (c && pv && nx) {
            pv.onclick = () => c.scrollBy({left:-300,behavior:'smooth'});
            nx.onclick = () => c.scrollBy({left:300,behavior:'smooth'});
        }
    });
  }, []);
...
<a href="#/article/10" className="space-y-2 group cursor-pointer block relative">
...
<a href="#/article/4" className="space-y-2 group cursor-pointer block relative">
<div className="aspect-[4/3] overflow-hidden">
...
<a href="#/article/2" className="space-y-2 group cursor-pointer block relative">
<div className="aspect-[4/3] overflow-hidden">
...
<a href="#" className="space-y-2 group cursor-pointer block relative">
<div className="aspect-[4/3] overflow-hidden">
...
<a href="#/article/4" className="absolute inset-0 z-10"><span className="sr-only">Read More</span></a>
...
{/*  Card 2  */}
<div className="flex-shrink-0 w-[280px] snap-start group cursor-pointer relative">
<a href="#/article/7" className="absolute inset-0 z-10"><span className="sr-only">Read More</span></a>
<div className="relative aspect-[16/10] w-full overflow-hidden mb-3">
...
{/*  Card 3  */}
<div className="flex-shrink-0 w-[280px] snap-start group cursor-pointer relative">
<a href="#/article/6" className="absolute inset-0 z-10"><span className="sr-only">Read More</span></a>
<div className="relative aspect-[16/10] w-full overflow-hidden mb-3">
...
{/*  Card 4  */}
<div className="flex-shrink-0 w-[280px] snap-start group cursor-pointer relative">
<a href="#/article/10" className="absolute inset-0 z-10"><span className="sr-only">Read More</span></a>
<div className="relative aspect-[16/10] w-full overflow-hidden mb-3">
...
<a href="#/category/visa-news/f1-opt-cpt" className="absolute inset-0 z-10"><span className="sr-only">View Category</span></a>
...
<a href="#/category/visa-news/h1b-visa" className="absolute inset-0 z-10"><span className="sr-only">View Category</span></a>
...
<a href="#/category/visa-news/green-card" className="absolute inset-0 z-10"><span className="sr-only">View Category</span></a>
...
<a href="#/category/visa-news" className="absolute inset-0 z-10"><span className="sr-only">View Category</span></a>
...
<a href="#/category/visa-news/b1-b2" className="absolute inset-0 z-10"><span className="sr-only">View Category</span></a>
...
<a href="#/article/1" className="absolute inset-0 z-10"><span className="sr-only">Read Article</span></a>
...
{/*  Feed Item 2  */}
<article className="group pb-6 border-b border-slate-100 flex gap-6 cursor-pointer relative">
<a href="#/article/8" className="absolute inset-0 z-10"><span className="sr-only">Read Article</span></a>
<div className="flex-grow">
<div className="flex items-center gap-2 mb-2">
...
<a href="#/article/11" className="absolute inset-0 z-10"><span className="sr-only">Read Article</span></a>
<div className="flex-grow">
<div className="flex items-center gap-2 mb-2">
...
<a href="#/article/2" className="absolute inset-0 z-10"><span className="sr-only">Read Article</span></a>
<div className="flex-grow">
<div className="flex items-center gap-2 mb-2">
<span className="text-[10px] font-bold text-primary uppercase tracking-widest">H1B Visa</span>
<span className="w-1 h-1 bg-slate-300"></span>
...
<div className="relative space-y-12">
      ...
      <div className="bg-slate-50 border border-slate-200 p-6 mb-8">
        ...
        <div className="space-y-6">
          <a className="group block" href="#/article/4">
          ...
          <a className="group block" href="#/article/7">
          ...
          <a className="group block" href="#/article/5">
      ...
      <div className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4 relative group cursor-pointer hover:bg-slate-50 transition-colors p-2 -mx-2">
            <a href="#/article/8" className="absolute inset-0 z-10"><span className="sr-only">Read More</span></a>
